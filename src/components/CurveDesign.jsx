    ...
    <>
      ...
      <div className='mt-10 ml-5'>
        <div className='relative hidden lg:block'>
          <img src="CurveBg.svg" alt="Curve Background" />

          <div className='absolute top-16  w-[1234.52px] h-[622px]'>
            <div className='flex gap-6'>
              <div className='w-[620.52px] h-[581.95px] mt-5 '>
              ...
              <div className='w-[587.48px] h-[622px] '>
                ...
                <div className='flex items-center'>
                  <div className='w-[406px] h-[435px] mx-auto items-center flex'>
                    ...
                    <div className='absolute right-24'><img src="CurveLine.svg" alt="" /></div>
                    <div>
                  ...
                  <div className='absolute -right-[62px] h-[52px] flex items-center gap-2'>
                  ...
                  <div className='absolute top-[505px] right-[210px]'>
