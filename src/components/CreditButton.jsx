...
const CreditButton = ({ title, img }) => {
  return (
    <div className='w-[120px] h-[50px] sm:w-[140px] sm:h-[60px] md:w-[160px] md:h-[65px] lg:w-[180px] lg:h-[70px] border-[1.5px] sm:border-[1.74px] border-[#7781FF] bg-white bg-opacity-[0.5] rounded-full shadow-md'>
